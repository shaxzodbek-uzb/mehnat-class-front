  ...
  <div>
    <CCard>
      <router-link :to="{ name: 'UserCreate' }">
        <CButton color="primary float-right" class="m-3"> <CIcon name="cil-user-plus"/> Yangi Foydalanuvchi yaratish </CButton>
      </router-link>
          ...
          <template #details="{item}">
              ...
              <CCardBody>
                  ...
                  <p class="text-muted">User since: {{item.registered}}</p>
                    <CButton @click="updateUser(item.id)" size="sm" color="info" class="">
                      Tahrirlash
                    </CButton>
